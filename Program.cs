    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!editorRuntimeObject.ShutDown) {
                ...
                ManifestCollection.Add("Praesentium temporibus sed sunt rem facere voluptates. Dolorum voluptatem at hic error iste porro amet ratione. Autem perferendis nostrum sit eum neque vel in dolores. Qui accusamus fugit minus ad voluptatem sint illum eos. Nihilcupiditate sed sunt excepturi in. Necessitatibus alias rem fugiat doloremque qui repellendus ut enim");
                ManifestCollection.Add("Short msg");
