...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
        internal static Div DisplayWindow;
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.

        internal static void SetUp() {
            DisplayWindow = new Div() {
                position = (0, 0),
        ...
        public static Div? CreateDiv ((ushort x, ushort y) position, (ushort x, ushort y) size, Div? nestedWithin = null) {
            ...
            Div result = new Div() {
                NestedWithin = nestedWithin != null ? nestedWithin : DisplayWindow,
            };
    ...
    class Div {
        ...
        // char[,] content = new char[XSpan.start - XSpan.end, YSpan.start - YSpan.end];
